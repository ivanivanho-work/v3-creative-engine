...
The migration is structured to minimize risk and allow parallel work:

1. **Phase 1 (Week 1):** Preparation - Setup, backups, directory structure ✅ **COMPLETE**
2. **Phase 2 (Week 2):** Shorts Intel Hub - Most complex tool (Cloud SQL, scheduler, MCP)
3. **Phase 3 (Week 3):** Shorts Brain - Simplest tool (vanilla HTML/JS)
4. **Phase 4 (Week 4):** Reorganize existing tools (Agent Collective, Creative Generator)
5. **Phase 5 (Week 5):** Cleanup and optimization
6. **Phase 6 (Week 6-7):** Template Stamper - **DEFERRED** until AWS→GCP migration completes

**Key Principle:** Template Stamper is migrated LAST to allow its AWS Remotion → Google Cloud migration to complete independently.

**Zero Downtime Guarantee:** All tools remain accessible at their current URLs during migration. New paths are added, tested, then old URLs redirect.
...
**Migrating Shorts Intel Hub first to allow Template Stamper AWS→GCP migration to complete**

**2.1 Merge Shorts Intel Hub Code**
...
**2.4 Migrate Cloud SQL Database**
...
**2.10 Update External References**
...
### Phase 3: APAC Shorts Brain Migration (Week 3)

**Migrating Shorts Brain (simple vanilla JS app) before Template Stamper**

**3.1 Copy Shorts Brain Code**
```bash
cd /Users/ivs/shorts-automation
...
**3.3 Verify Firestore Collections**
...
**3.5 Update External References**
- Update hub.html link
- Add redirect from old URL

---

### Phase 4: Agent Collective & Creative Generator Reorganization (Week 4)

**Reorganize existing tools for consistency with new structure**

**4.1 Reorganize Agent Collective**
- Currently at `public/agent-collective.html`
- Move to `public/agent-collective/index.html` for consistency
- Update all internal links
- Update hub.html to point to new path

**4.2 Reorganize Creative Generator**
- Currently at `public/index.html`, `public/script.js`, `public/style.css`
- Move to `public/creative-generator/` for consistency
- Update hub.html to point to new path
- Ensure MCP bridge to Template Stamper works with new paths

**4.3 Update Hub Landing Page**
- Update all tool links to new paths
- Ensure backward compatibility with old URLs via rewrites
...
**Final cleanup and optimization before Template Stamper migration**

**5.1 Clean Up Legacy Files**
- Archive 50+ legacy HTML version files from Creative Generator
- Keep only production files
- Document what was archived

**5.2 Optimize Firestore Rules**
- Consolidate rules from all migrated tools
- Remove duplicate rules
- Test security comprehensively

**5.3 Optimize Cloud Storage Rules**
- Consolidate storage paths
- Update CORS settings if needed
- Test file uploads/downloads

**5.4 Documentation**
- Update README files for all tools
- Document new URL structure
- Create migration completion report

**5.5 Performance Testing**
- Benchmark load times for all tools
- Test MCP bridges under load
- Verify Cloud Functions cold start times

**5.6 Deploy Final Optimizations**
```bash
