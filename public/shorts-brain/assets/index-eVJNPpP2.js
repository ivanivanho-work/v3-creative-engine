 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bx=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Hx=new Oa(3e4,6e4);function qf(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function oo(t,e,n,r,s={}){return U0(t,s,async()=>{let i={},o={};r&&(e==="GET"?o=r:i={body:JSON.stringify(r)});const l=Da({key:t.config.apiKey,...o}).slice(1),u=await t._getAdditionalHeaders();u["Content-Type"]="application/json",t.languageCode&&(u["X-Firebase-Locale"]=t.languageCode);const c={method:e,headers:u,...i};return pS()||(c.referrerPolicy="no-referrer"),t.emulatorConfig&&io(t.emulatorConfig.host)&&(c.credentials="include"),j0.fetch()(await F0(t,t.config.apiHost,n,l),c)})}async function U0(t,e,n){t._canInitEmulator=!1;const r={...zx,...e};try{const s=new Wx(t),i=await Promise.race([n(),s.promise]);s.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw gl(t,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const l=i.ok?o.errorMessage:o.error.message,[u,c]=l.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw gl(t,"credential-already-in-use",o);if(u==="EMAIL_EXISTS")throw gl(t,"email-already-in-use",o);if(u==="USER_DISABLED")throw gl(t,"user-disabled",o);const f=r[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw zf(t,f,c);ur(t,f)}}catch(s){if(s instanceof pr)throw s;ur(t,"network-request-failed",{message:String(s)})}}async function qx(t,e,n,r,s={}){const i=await oo(t,e,n,r,s);return"mfaPendingCredential"in i&&ur(t,"multi-factor-auth-required",{_serverResponse:i}),i}async function F0(t,e,n,r){const s=`${e}${n}?${r}`,i=t,o=i.config.emulator?Hf(t.config,s):`${t.config.apiScheme}://${s}`;return Bx.includes(n)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}class Wx{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(Hn(this.auth,"network-request-failed")),Hx.get())})}}function gl(t,e,n){const r={appName:t.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const s=Hn(t,e,r);return s.customData._tokenResponse=n,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dA(t,e){const n=rc(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(Zs(i,e??{}))return s;ur(s,"already-initialized")}return n.initialize({options:e})}function fA(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(xr);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function pA(t,e,n){const r=sc(t);oe(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=X0(e),{host:o,port:l}=mA(e),u=l===null?"":`:${l}`,c={url:`${i}//${o}${u}/`},f=Object.freeze({host:o,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){oe(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),oe(Zs(c,r.config.emulator)&&Zs(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=c,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,io(o)?jf(`${i}//${o}${u}`):gA()}function X0(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function mA(t){const e=X0(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Ug(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:Ug(o)}}}function Ug(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function gA(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cw(t,e){return e?xr(e):(oe(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hw{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:l}=e;if(o){this.reject(o);return}const u={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(c){this.reject(c)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return UA;case"linkViaPopup":case"linkViaRedirect":return $A;case"reauthViaPopup":case"reauthViaRedirect":return FA;default:ur(this.auth,"internal-error")}}resolve(e){Vr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Vr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dh="webStorageSupport";class Ak{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=iw,this._completeRedirectFn=JA,this._overrideRedirectResult=GA}async _openPopup(e,n,r,s){var o;Vr((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const i=await Wg(e,n,r,vd(),s);return wk(e,i,Jf())}async _openRedirect(e,n,r,s){await this._originValidation(e);const i=await Wg(e,n,r,vd(),s);return RA(i),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:s,promise:i}=this.eventManagers[n];return s?Promise.resolve(s):(Vr(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await pk(e),r=new XA(e);return n.register("authEvent",s=>(oe(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(dh,{type:dh},s=>{var o;const i=(o=s==null?void 0:s[0])==null?void 0:o[dh];i!==void 0&&n(!!i),ur(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=rk(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return J0()||H0()||Gf()}}const kk=Ak;var Gg="@firebase/auth",Kg="1.13.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=Fn.makeFromUrl(e,n)}catch{return new Fn(e,"")}if(r.path==="")return r;throw Hk(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(D){D.path.charAt(D.path.length-1)==="/"&&(D.path_=D.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),u={bucket:1,path:3};function c(D){D.path_=decodeURIComponent(D.path)}const f="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),v="(/([^?#]*).*)?$",k=new RegExp(`^https?://${p}/${f}/b/${s}/o${v}`,"i"),P={bucket:1,path:3},N=n===pw?"(?:storage.googleapis.com|storage.cloud.google.com)":n,V="([^?#]*)",S=new RegExp(`^https?://${N}/${s}/${V}`,"i"),A=[{regex:l,indices:u,postModify:i},{regex:k,indices:P,postModify:c},{regex:S,indices:{bucket:1,path:2},postModify:c}];for(let D=0;D<A.length;D++){const L=A[D],U=L.regex.exec(e);if(U){const g=U[L.indices.bucket];let y=U[L.indices.path];y||(y=""),r=new Fn(g,y),L.postModify(r);break}}if(r==null)throw Bk(e);return r}}class Wk{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gk(t,e,n){let r=1,s=null,i=null,o=!1,l=0;function u(){return l===2}let c=!1;function f(...V){c||(c=!0,e.apply(null,V))}function p(V){s=setTimeout(()=>{s=null,t(k,u())},V)}function v(){i&&clearTimeout(i)}function k(V,...S){if(c){v();return}if(V){v(),f.call(null,V,...S);return}if(u()||o){v(),f.call(null,V,...S);return}r<64&&(r*=2);let A;l===1?(l=2,A=0):A=(r+Math.random())*1e3,p(A)}let P=!1;function N(V){P||(P=!0,v(),!c&&(s!==null?(V||(l=2),clearTimeout(s),p(0)):V||(l=1)))}return p(0),i=setTimeout(()=>{o=!0,N(!0)},n),N}function Kk(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xk{constructor(e,n,r,s,i,o,l,u,c,f,p,v=!0,k=!1){this.url_=e,this.method_=n,this.headers_=r,this.body_=s,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=l,this.errorCallback_=u,this.timeout_=c,this.progressCallback_=f,this.connectionFactory_=p,this.retry=v,this.isUsingEmulator=k,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((P,N)=>{this.resolve_=P,this.reject_=N,this.start_()})}start_(){const e=(r,s)=>{if(s){r(!1,new yl(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=l=>{const u=l.loaded,c=l.lengthComputable?l.total:-1;this.progressCallback_!==null&&this.progressCallback_(u,c)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const l=i.getErrorCode()===ku.NO_ERROR,u=i.getStatus();if(!l||Yk(u,this.additionalRetryCodes_)&&this.retry){const f=i.getErrorCode()===ku.ABORT;r(!1,new yl(!1,null,f));return}const c=this.successCodes_.indexOf(u)!==-1;r(!0,new yl(c,i))})},n=(r,s)=>{const i=this.resolve_,o=this.reject_,l=s.connection;if(s.wasSuccessCode)try{const u=this.callback_(l,l.getResponse());Qk(u)?i(u):i()}catch(u){o(u)}else if(l!==null){const u=Fk();u.serverResponse=l.getErrorText(),this.errorCallback_?o(this.errorCallback_(l,u)):o(u)}else if(s.canceled){const u=this.appDelete_?mw():zk();o(u)}else{const u=$k();o(u)}};this.canceled_?n(!1,new yl(!1,null,!0)):this.backoffId_=Gk(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&Kk(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class yl{constructor(e,n,r){this.wasSuccessCode=e,this.connection=n,this.canceled=!!r}}function Zk(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function eC(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function tC(t,e){e&&(t["X-Firebase-GMPID"]=e)}function nC(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function rC(t,e,n,r,s,i,o=!0,l=!1){const u=Jk(t.urlParams),c=t.url+u,f=Object.assign({},t.headers);return tC(f,e),Zk(f,n),eC(f,i),nC(f,r),new Xk(c,t.method,f,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s,o,l)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var ps,yw;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(g,y){function w(){}w.prototype=y.prototype,g.F=y.prototype,g.prototype=new w,g.prototype.constructor=g,g.D=function(E,x,C){for(var T=Array(arguments.length-2),re=2;re<arguments.length;re++)T[re-2]=arguments[re];return y.prototype[x].apply(E,T)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(g,y,w){w||(w=0);const E=Array(16);if(typeof y=="string")for(var x=0;x<16;++x)E[x]=y.charCodeAt(w++)|y.charCodeAt(w++)<<8|y.charCodeAt(w++)<<16|y.charCodeAt(w++)<<24;else for(x=0;x<16;++x)E[x]=y[w++]|y[w++]<<8|y[w++]<<16|y[w++]<<24;y=g.g[0],w=g.g[1],x=g.g[2];let C=g.g[3],T;T=y+(C^w&(x^C))+E[0]+3614090360&4294967295,y=w+(T<<7&4294967295|T>>>25),T=C+(x^y&(w^x))+E[1]+3905402710&4294967295,C=y+(T<<12&4294967295|T>>>20),T=x+(w^C&(y^w))+E[2]+606105819&4294967295,x=C+(T<<17&4294967295|T>>>15),T=w+(y^x&(C^y))+E[3]+3250441966&4294967295,w=x+(T<<22&4294967295|T>>>10),T=y+(C^w&(x^C))+E[4]+4118548399&4294967295,y=w+(T<<7&4294967295|T>>>25),T=C+(x^y&(w^x))+E[5]+1200080426&4294967295,C=y+(T<<12&4294967295|T>>>20),T=x+(w^C&(y^w))+E[6]+2821735955&4294967295,x=C+(T<<17&4294967295|T>>>15),T=w+(y^x&(C^y))+E[7]+4249261313&4294967295,w=x+(T<<22&4294967295|T>>>10),T=y+(C^w&(x^C))+E[8]+1770035416&4294967295,y=w+(T<<7&4294967295|T>>>25),T=C+(x^y&(w^x))+E[9]+2336552879&4294967295,C=y+(T<<12&4294967295|T>>>20),T=x+(w^C&(y^w))+E[10]+4294925233&4294967295,x=C+(T<<17&4294967295|T>>>15),T=w+(y^x&(C^y))+E[11]+2304563134&4294967295,w=x+(T<<22&4294967295|T>>>10),T=y+(C^w&(x^C))+E[12]+1804603682&4294967295,y=w+(T<<7&4294967295|T>>>25),T=C+(x^y&(w^x))+E[13]+4254626195&4294967295,C=y+(T<<12&4294967295|T>>>20),T=x+(w^C&(y^w))+E[14]+2792965006&4294967295,x=C+(T<<17&4294967295|T>>>15),T=w+(y^x&(C^y))+E[15]+1236535329&4294967295,w=x+(T<<22&4294967295|T>>>10),T=y+(x^C&(w^x))+E[1]+4129170786&4294967295,y=w+(T<<5&4294967295|T>>>27),T=C+(w^x&(y^w))+E[6]+3225465664&4294967295,C=y+(T<<9&4294967295|T>>>23),T=x+(y^w&(C^y))+E[11]+643717713&4294967295,x=C+(T<<14&4294967295|T>>>18),T=w+(C^y&(x^C))+E[0]+3921069994&4294967295,w=x+(T<<20&4294967295|T>>>12),T=y+(x^C&(w^x))+E[5]+3593408605&4294967295,y=w+(T<<5&4294967295|T>>>27),T=C+(w^x&(y^w))+E[10]+38016083&4294967295,C=y+(T<<9&4294967295|T>>>23),T=x+(y^w&(C^y))+E[15]+3634488961&4294967295,x=C+(T<<14&4294967295|T>>>18),T=w+(C^y&(x^C))+E[4]+3889429448&4294967295,w=x+(T<<20&4294967295|T>>>12),T=y+(x^C&(w^x))+E[9]+568446438&4294967295,y=w+(T<<5&4294967295|T>>>27),T=C+(w^x&(y^w))+E[14]+3275163606&4294967295,C=y+(T<<9&4294967295|T>>>23),T=x+(y^w&(C^y))+E[3]+4107603335&4294967295,x=C+(T<<14&4294967295|T>>>18),T=w+(C^y&(x^C))+E[8]+1163531501&4294967295,w=x+(T<<20&4294967295|T>>>12),T=y+(x^C&(w^x))+E[13]+2850285829&4294967295,y=w+(T<<5&4294967295|T>>>27),T=C+(w^x&(y^w))+E[2]+4243563512&4294967295,C=y+(T<<9&4294967295|T>>>23),T=x+(y^w&(C^y))+E[7]+1735328473&4294967295,x=C+(T<<14&4294967295|T>>>18),T=w+(C^y&(x^C))+E[12]+2368359562&4294967295,w=x+(T<<20&4294967295|T>>>12),T=y+(w^x^C)+E[5]+4294588738&4294967295,y=w+(T<<4&4294967295|T>>>28),T=C+(y^w^x)+E[8]+2272392833&4294967295,C=y+(T<<11&4294967295|T>>>21),T=x+(C^y^w)+E[11]+1839030562&4294967295,x=C+(T<<16&4294967295|T>>>16),T=w+(x^C^y)+E[14]+4259657740&4294967295,w=x+(T<<23&4294967295|T>>>9),T=y+(w^x^C)+E[1]+2763975236&4294967295,y=w+(T<<4&4294967295|T>>>28),T=C+(y^w^x)+E[4]+1272893353&4294967295,C=y+(T<<11&4294967295|T>>>21),T=x+(C^y^w)+E[7]+4139469664&4294967295,x=C+(T<<16&4294967295|T>>>16),T=w+(x^C^y)+E[10]+3200236656&4294967295,w=x+(T<<23&4294967295|T>>>9),T=y+(w^x^C)+E[13]+681279174&4294967295,y=w+(T<<4&4294967295|T>>>28),T=C+(y^w^x)+E[0]+3936430074&4294967295,C=y+(T<<11&4294967295|T>>>21),T=x+(C^y^w)+E[3]+3572445317&4294967295,x=C+(T<<16&4294967295|T>>>16),T=w+(x^C^y)+E[6]+76029189&4294967295,w=x+(T<<23&4294967295|T>>>9),T=y+(w^x^C)+E[9]+3654602809&4294967295,y=w+(T<<4&4294967295|T>>>28),T=C+(y^w^x)+E[12]+3873151461&4294967295,C=y+(T<<11&4294967295|T>>>21),T=x+(C^y^w)+E[15]+530742520&4294967295,x=C+(T<<16&4294967295|T>>>16),T=w+(x^C^y)+E[2]+3299628645&4294967295,w=x+(T<<23&4294967295|T>>>9),T=y+(x^(w|~C))+E[0]+4096336452&4294967295,y=w+(T<<6&4294967295|T>>>26),T=C+(w^(y|~x))+E[7]+1126891415&4294967295,C=y+(T<<10&4294967295|T>>>22),T=x+(y^(C|~w))+E[14]+2878612391&4294967295,x=C+(T<<15&4294967295|T>>>17),T=w+(C^(x|~y))+E[5]+4237533241&4294967295,w=x+(T<<21&4294967295|T>>>11),T=y+(x^(w|~C))+E[12]+1700485571&4294967295,y=w+(T<<6&4294967295|T>>>26),T=C+(w^(y|~x))+E[3]+2399980690&4294967295,C=y+(T<<10&4294967295|T>>>22),T=x+(y^(C|~w))+E[10]+4293915773&4294967295,x=C+(T<<15&4294967295|T>>>17),T=w+(C^(x|~y))+E[1]+2240044497&4294967295,w=x+(T<<21&4294967295|T>>>11),T=y+(x^(w|~C))+E[8]+1873313359&4294967295,y=w+(T<<6&4294967295|T>>>26),T=C+(w^(y|~x))+E[15]+4264355552&4294967295,C=y+(T<<10&4294967295|T>>>22),T=x+(y^(C|~w))+E[6]+2734768916&4294967295,x=C+(T<<15&4294967295|T>>>17),T=w+(C^(x|~y))+E[13]+1309151649&4294967295,w=x+(T<<21&4294967295|T>>>11),T=y+(x^(w|~C))+E[4]+4149444226&4294967295,y=w+(T<<6&4294967295|T>>>26),T=C+(w^(y|~x))+E[11]+3174756917&4294967295,C=y+(T<<10&4294967295|T>>>22),T=x+(y^(C|~w))+E[2]+718787259&4294967295,x=C+(T<<15&4294967295|T>>>17),T=w+(C^(x|~y))+E[9]+3951481745&4294967295,g.g[0]=g.g[0]+y&4294967295,g.g[1]=g.g[1]+(x+(T<<21&4294967295|T>>>11))&4294967295,g.g[2]=g.g[2]+x&4294967295,g.g[3]=g.g[3]+C&4294967295}r.prototype.v=function(g,y){y===void 0&&(y=g.length);const w=y-this.blockSize,E=this.C;let x=this.h,C=0;for(;C<y;){if(x==0)for(;C<=w;)s(this,g,C),C+=this.blockSize;if(typeof g=="string"){for(;C<y;)if(E[x++]=g.charCodeAt(C++),x==this.blockSize){s(this,E),x=0;break}}else for(;C<y;)if(E[x++]=g[C++],x==this.blockSize){s(this,E),x=0;break}}this.h=x,this.o+=y},r.prototype.A=function(){var g=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);g[0]=128;for(var y=1;y<g.length-8;++y)g[y]=0;y=this.o*8;for(var w=g.length-8;w<g.length;++w)g[w]=y&255,y/=256;for(this.v(g),g=Array(16),y=0,w=0;w<4;++w)for(let E=0;E<32;E+=8)g[y++]=this.g[w]>>>E&255;return g};function i(g,y){var w=l;return Object.prototype.hasOwnProperty.call(w,g)?w[g]:w[g]=y(g)}function o(g,y){this.h=y;const w=[];let E=!0;for(let x=g.length-1;x>=0;x--){const C=g[x]|0;E&&C==y||(w[x]=C,E=!1)}this.g=w}var l={};function u(g){return-128<=g&&g<128?i(g,function(y){return new o([y|0],y<0?-1:0)}):new o([g|0],g<0?-1:0)}function c(g){if(isNaN(g)||!isFinite(g))return p;if(g<0)return V(c(-g));const y=[];let w=1;for(let E=0;g>=w;E++)y[E]=g/w|0,w*=4294967296;return new o(y,0)}function f(g,y){if(g.length==0)throw Error("number format error: empty string");if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(g.charAt(0)=="-")return V(f(g.substring(1),y));if(g.indexOf("-")>=0)throw Error('number format error: interior "-" character');const w=c(Math.pow(y,8));let E=p;for(let C=0;C<g.length;C+=8){var x=Math.min(8,g.length-C);const T=parseInt(g.substring(C,C+x),y);x<8?(x=c(Math.pow(y,x)),E=E.j(x).add(c(T))):(E=E.j(w),E=E.add(c(T)))}return E}var p=u(0),v=u(1),k=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-V(this).m();let g=0,y=1;for(let w=0;w<this.g.length;w++){const E=this.i(w);g+=(E>=0?E:4294967296+E)*y,y*=4294967296}return g},t.toString=function(g){if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(P(this))return"0";if(N(this))return"-"+V(this).toString(g);const y=c(Math.pow(g,6));var w=this;let E="";for(;;){const x=D(w,y).g;w=S(w,x.j(y));let C=((w.g.length>0?w.g[0]:w.h)>>>0).toString(g);if(w=x,P(w))return C+E;for(;C.length<6;)C="0"+C;E=C+E}},t.i=function(g){return g<0?0:g<this.g.length?this.g[g]:this.h};function P(g){if(g.h!=0)return!1;for(let y=0;y<g.g.length;y++)if(g.g[y]!=0)return!1;return!0}function N(g){return g.h==-1}t.l=function(g){return g=S(this,g),N(g)?-1:P(g)?0:1};function V(g){const y=g.g.length,w=[];for(let E=0;E<y;E++)w[E]=~g.g[E];return new o(w,~g.h).add(v)}t.abs=function(){return N(this)?V(this):this},t.add=function(g){const y=Math.max(this.g.length,g.g.length),w=[];let E=0;for(let x=0;x<=y;x++){let C=E+(this.i(x)&65535)+(g.i(x)&65535),T=(C>>>16)+(this.i(x)>>>16)+(g.i(x)>>>16);E=T>>>16,C&=65535,T&=65535,w[x]=T<<16|C}return new o(w,w[w.length-1]&-2147483648?-1:0)};function S(g,y){return g.add(V(y))}t.j=function(g){if(P(this)||P(g))return p;if(N(this))return N(g)?V(this).j(V(g)):V(V(this).j(g));if(N(g))return V(this.j(V(g)));if(this.l(k)<0&&g.l(k)<0)return c(this.m()*g.m());const y=this.g.length+g.g.length,w=[];for(var E=0;E<2*y;E++)w[E]=0;for(E=0;E<this.g.length;E++)for(let x=0;x<g.g.length;x++){const C=this.i(E)>>>16,T=this.i(E)&65535,re=g.i(x)>>>16,le=g.i(x)&65535;w[2*E+2*x]+=T*le,I(w,2*E+2*x),w[2*E+2*x+1]+=C*le,I(w,2*E+2*x+1),w[2*E+2*x+1]+=T*re,I(w,2*E+2*x+1),w[2*E+2*x+2]+=C*re,I(w,2*E+2*x+2)}for(g=0;g<y;g++)w[g]=w[2*g+1]<<16|w[2*g];for(g=y;g<2*y;g++)w[g]=0;return new o(w,0)};function I(g,y){for(;(g[y]&65535)!=g[y];)g[y+1]+=g[y]>>>16,g[y]&=65535,y++}function A(g,y){this.g=g,this.h=y}function D(g,y){if(P(y))throw Error("division by zero");if(P(g))return new A(p,p);if(N(g))return y=D(V(g),y),new A(V(y.g),V(y.h));if(N(y))return y=D(g,V(y)),new A(V(y.g),y.h);if(g.g.length>30){if(N(g)||N(y))throw Error("slowDivide_ only works with positive integers.");for(var w=v,E=y;E.l(g)<=0;)w=L(w),E=L(E);var x=U(w,1),C=U(E,1);for(E=U(E,2),w=U(w,2);!P(E);){var T=C.add(E);T.l(g)<=0&&(x=x.add(w),C=T),E=U(E,1),w=U(w,1)}return y=S(g,x.j(y)),new A(x,y)}for(x=p;g.l(y)>=0;){for(w=Math.max(1,Math.floor(g.m()/y.m())),E=Math.ceil(Math.log(w)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),C=c(w),T=C.j(y);N(T)||T.l(g)>0;)w-=E,C=c(w),T=C.j(y);P(C)&&(C=v),x=x.add(C),g=S(g,T)}return new A(x,g)}t.B=function(g){return D(this,g).h},t.and=function(g){const y=Math.max(this.g.length,g.g.length),w=[];for(let E=0;E<y;E++)w[E]=this.i(E)&g.i(E);return new o(w,this.h&g.h)},t.or=function(g){const y=Math.max(this.g.length,g.g.length),w=[];for(let E=0;E<y;E++)w[E]=this.i(E)|g.i(E);return new o(w,this.h|g.h)},t.xor=function(g){const y=Math.max(this.g.length,g.g.length),w=[];for(let E=0;E<y;E++)w[E]=this.i(E)^g.i(E);return new o(w,this.h^g.h)};function L(g){const y=g.g.length+1,w=[];for(let E=0;E<y;E++)w[E]=g.i(E)<<1|g.i(E-1)>>>31;return new o(w,g.h)}function U(g,y){const w=y>>5;y%=32;const E=g.g.length-w,x=[];for(let C=0;C<E;C++)x[C]=y>0?g.i(C+w)>>>y|g.i(C+w+1)<<32-y:g.i(C+w);return new o(x,g.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,yw=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=f,ps=o}).apply(typeof ty<"u"?ty:typeof self<"u"?self:typeof window<"u"?window:{});var _l=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var _w,Mo,vw,zl,Td,ww,Ew,Tw;(function(){var t,e=Object.defineProperty;function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof _l=="object"&&_l];for(var h=0;h<a.length;++h){var d=a[h];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=n(this);function s(a,h){if(h)e:{var d=r;a=a.split(".");for(var _=0;_<a.length-1;_++){var R=a[_];if(!(R in d))break e;d=d[R]}a=a[a.length-1],_=d[a],h=h(_),h!=_&&h!=null&&e(d,a,{configurable:!0,writable:!0,value:h})}}s("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(a){return a||function(h){var d=[],_;for(_ in h)Object.prototype.hasOwnProperty.call(h,_)&&d.push([_,h[_]]);return d}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},o=this||self;function l(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function u(a,h,d){return a.call.apply(a.bind,arguments)}function c(a,h,d){return c=u,c.apply(null,arguments)}function f(a,h){var d=Array.prototype.slice.call(arguments,1);return function(){var _=d.slice();return _.push.apply(_,arguments),a.apply(this,_)}}function p(a,h){function d(){}d.prototype=h.prototype,a.Z=h.prototype,a.prototype=new d,a.prototype.constructor=a,a.Ob=function(_,R,b){for(var q=Array(arguments.length-2),me=2;me<arguments.length;me++)q[me-2]=arguments[me];return h.prototype[R].apply(_,q)}}var v=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function k(a){const h=a.length;if(h>0){const d=Array(h);for(let _=0;_<h;_++)d[_]=a[_];return d}return[]}function P(a,h){for(let _=1;_<arguments.length;_++){const R=arguments[_];var d=typeof R;if(d=d!="object"?d:R?Array.isArray(R)?"array":d:"null",d=="array"||d=="object"&&typeof R.length=="number"){d=a.length||0;const b=R.length||0;a.length=d+b;for(let q=0;q<b;q++)a[d+q]=R[q]}else a.push(R)}}class N{constructor(h,d){this.i=h,this.j=d,this.h=0,this.g=null}get(){let h;return this.h>0?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function V(a){o.setTimeout(()=>{throw a},0)}function S(){var a=g;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class I{constructor(){this.h=this.g=null}add(h,d){const _=A.get();_.set(h,d),this.h?this.h.next=_:this.g=_,this.h=_}}var A=new N(()=>new D,a=>a.reset());class D{constructor(){this.next=this.g=this.h=null}set(h,d){this.h=h,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let L,U=!1,g=new I,y=()=>{const a=Promise.resolve(void 0);L=()=>{a.then(w)}};function w(){for(var a;a=S();){try{a.h.call(a.g)}catch(d){V(d)}var h=A;h.j(a),h.h<100&&(h.h++,a.next=h.g,h.g=a)}U=!1}function E(){this.u=this.u,this.C=this.C}E.prototype.u=!1,E.prototype.dispose=function(){this.u||(this.u=!0,this.N())},E.prototype[Symbol.dispose]=function(){this.dispose()},E.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function x(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}x.prototype.h=function(){this.defaultPrevented=!0};var C=function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};o.addEventListener("test",d,h),o.removeEventListener("test",d,h)}catch{}return a}();function T(a){return/^[\s\xa0]*$/.test(a)}function re(a,h){x.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,h)}p(re,x),re.prototype.init=function(a,h){const d=this.type=a.type,_=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget,h||(d=="mouseover"?h=a.fromElement:d=="mouseout"&&(h=a.toElement)),this.relatedTarget=h,_?(this.clientX=_.clientX!==void 0?_.clientX:_.pageX,this.clientY=_.clientY!==void 0?_.clientY:_.pageY,this.screenX=_.screenX||0,this.screenY=_.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&re.Z.h.call(this)},re.prototype.h=function(){re.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var le="closure_listenable_"+(Math.random()*1e6|0),Vt=0;function ye(a,h,d,_,R){this.listener=a,this.proxy=null,this.src=h,this.type=d,this.capture=!!_,this.ha=R,this.key=++Vt,this.da=this.fa=!1}function z(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Y(a,h,d){for(const _ in a)h.call(d,a[_],_,a)}function B(a,h){for(const d in a)h.call(void 0,a[d],d,a)}function he(a){const h={};for(const d in a)h[d]=a[d];return h}const pe="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Qe(a,h){let d,_;for(let R=1;R<arguments.length;R++){_=arguments[R];for(d in _)a[d]=_[d];for(let b=0;b<pe.length;b++)d=pe[b],Object.prototype.hasOwnProperty.call(_,d)&&(a[d]=_[d])}}function ut(a){this.src=a,this.g={},this.h=0}ut.prototype.add=function(a,h,d,_,R){const b=a.toString();a=this.g[b],a||(a=this.g[b]=[],this.h++);const q=ot(a,h,_,R);return q>-1?(h=a[q],d||(h.fa=!1)):(h=new ye(h,this.src,b,!!_,R),h.fa=d,a.push(h)),h};function Tt(a,h){const d=h.type;if(d in a.g){var _=a.g[d],R=Array.prototype.indexOf.call(_,h,void 0),b;(b=R>=0)&&Array.prototype.splice.call(_,R,1),b&&(z(h),a.g[d].length==0&&(delete a.g[d],a.h--))}}function ot(a,h,d,_){for(let R=0;R<a.length;++R){const b=a[R];if(!b.da&&b.listener==h&&b.capture==!!d&&b.ha==_)return R}return-1}var ct="closure_lm_"+(Math.random()*1e6|0),Ht={};function Ct(a,h,d,_,R){if(Array.isArray(h)){for(let b=0;b<h.length;b++)Ct(a,h[b],d,_,R);return null}return d=H(d),a&&a[le]?a.J(h,d,l(_)?!!_.capture:!1,R):gt(a,h,d,!1,_,R)}function gt(a,h,d,_,R,b){if(!h)throw Error("Invalid event type");const q=l(R)?!!R.capture:!!R;let me=O(a);if(me||(a[ct]=me=new ut(a)),d=me.add(h,d,_,q,b),d.proxy)return d;if(_=qt(),d.proxy=_,_.src=a,_.listener=d,a.addEventListener)C||(R=q),R===void 0&&(R=!1),a.addEventListener(h.toString(),_,R);else if(a.attachEvent)a.attachEvent(tn(h.toString()),_);else if(a.addListener&&a.removeListener)a.addListener(_);else throw Error("addEventListener and attachEvent are unavailable.");return d}function qt(){function a(d){return h.call(a.src,a.listener,d)}const h=Nn;return a}function ge(a,h,d,_,R){if(Array.isArray(h))for(var b=0;b<h.length;b++)ge(a,h[b],d,_,R);else _=l(_)?!!_.capture:!!_,d=H(d),a&&a[le]?(a=a.i,b=String(h).toString(),b in a.g&&(h=a.g[b],d=ot(h,d,_,R),d>-1&&(z(h[d]),Array.prototype.splice.call(h,d,1),h.length==0&&(delete a.g[b],a.h--)))):a&&(a=O(a))&&(h=a.g[h.toString()],a=-1,h&&(a=ot(h,d,_,R)),(d=a>-1?h[a]:null)&&Ze(d))}function Ze(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[le])Tt(h.i,a);else{var d=a.type,_=a.proxy;h.removeEventListener?h.removeEventListener(d,_,a.capture):h.detachEvent?h.detachEvent(tn(d),_):h.addListener&&h.removeListener&&h.removeListener(_),(d=O(h))?(Tt(d,a),d.h==0&&(d.src=null,h[ct]=null)):z(a)}}}function tn(a){return a in Ht?Ht[a]:Ht[a]="on"+a}function Nn(a,h){if(a.da)a=!0;else{h=new re(h,this);const d=a.listener,_=a.ha||a.src;a.fa&&Ze(a),a=d.call(_,h)}return a}function O(a){return a=a[ct],a instanceof ut?a:null}var $="__closure_events_fn_"+(Math.random()*1e9>>>0);function H(a){return typeof a=="function"?a:(a[$]||(a[$]=function(h){return a.handleEvent(h)}),a[$])}function W(){E.call(this),this.i=new ut(this),this.M=this,this.G=null}p(W,E),W.prototype[le]=!0,W.prototype.removeEventListener=function(a,h,d,_){ge(this,a,h,d,_)};function G(a,h){var d,_=a.G;if(_)for(d=[];_;_=_.G)d.push(_);if(a=a.M,_=h.type||h,typeof h=="string")h=new x(h,a);else if(h instanceof x)h.target=h.target||a;else{var R=h;h=new x(_,a),Qe(h,R)}R=!0;let b,q;if(d)for(q=d.length-1;q>=0;q--)b=h.g=d[q],R=Z(b,_,!0,h)&&R;if(b=h.g=a,R=Z(b,_,!0,h)&&R,R=Z(b,_,!1,h)&&R,d)for(q=0;q<d.length;q++)b=h.g=d[q],R=Z(b,_,!1,h)&&R}W.prototype.N=function(){if(W.Z.N.call(this),this.i){var a=this.i;for(const h in a.g){const d=a.g[h];for(let _=0;_<d.length;_++)z(d[_]);delete a.g[h],a.h--}}this.G=null},W.prototype.J=function(a,h,d,_){return this.i.add(String(a),h,!1,d,_)},W.prototype.K=function(a,h,d,_){return this.i.add(String(a),h,!0,d,_)};function Z(a,h,d,_){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();let R=!0;for(let b=0;b<h.length;++b){const q=h[b];if(q&&!q.da&&q.capture==d){const me=q.listener,It=q.ha||q.src;q.fa&&Tt(a.i,q),R=me.call(It,_)!==!1&&R}}return R&&!_.defaultPrevented}function X(a,h){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=c(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(h)>2147483647?-1:o.setTimeout(a,h||0)}function se(a){a.g=X(()=>{a.g=null,a.i&&(a.i=!1,se(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class je extends E{constructor(h,d){super(),this.m=h,this.l=d,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:se(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Je(a){E.call(this),this.h=a,this.g={}}p(Je,E);var Ue=[];function be(a){Y(a.g,function(h,d){this.g.hasOwnProperty(d)&&Ze(h)},a),a.g={}}Je.prototype.N=function(){Je.Z.N.call(this),be(this)},Je.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var et=o.JSON.stringify,tt=o.JSON.parse,Ur=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function Rt(){}function bn(){}var gr={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function di(){x.call(this,"d")}p(di,x);function Ps(){x.call(this,"c")}p(Ps,x);var yr={},de=null;function Re(){return de=de||new W}yr.Ia="serverreachability";function ee(a){x.call(this,yr.Ia,a)}p(ee,x);function De(a){const h=Re();G(h,new ee(h))}yr.STAT_EVENT="statevent";function fe(a,h){x.call(this,yr.STAT_EVENT,a),this.stat=h}p(fe,x);function ke(a){const h=Re();G(h,new fe(h,a))}yr.Ja="timingevent";function Ie(a,h){x.call(this,yr.Ja,a),this.size=h}p(Ie,x);function Se(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},h)}function Pe(){this.g=!0}Pe.prototype.ua=function(){this.g=!1};function Ce(a,h,d,_,R,b){a.info(function(){if(a.g)if(b){var q="",me=b.split("&");for(let Fe=0;Fe<me.length;Fe++){var It=me[Fe].split("=");if(It.length>1){const Pt=It[0];It=It[1];const Jn=Pt.split("_");q=Jn.length>=2&&Jn[1]=="type"?q+(Pt+"="+It+"&"):q+(Pt+"=redacted&")}}}else q=null;else q=b;return"XMLHTTP REQ ("+_+") [attempt "+R+"]: "+h+`
`+d+`
`+q})}function Oe(a,h,d,_,R,b,q){a.info(function(){return"XMLHTTP RESP ("+_+") [ attempt "+R+"]: "+h+`
`+d+`
`+b+" "+q})}function Ee(a,h,d,_){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+Ve(a,d)+(_?" "+_:"")})}function ht(a,h){a.info(function(){return"TIMEOUT: "+h})}Pe.prototype.info=function(){};function Ve(a,h){if(!a.g)return h;if(!h)return null;try{const b=JSON.parse(h);if(b){for(a=0;a<b.length;a++)if(Array.isArray(b[a])){var d=b[a];if(!(d.length<2)){var _=d[1];if(Array.isArray(_)&&!(_.length<1)){var R=_[0];if(R!="noop"&&R!="stop"&&R!="close")for(let q=1;q<_.length;q++)_[q]=""}}}}return et(b)}catch{return h}}var Le={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Wt={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Kn;function dt(){}p(dt,Rt),dt.prototype.g=function(){return new XMLHttpRequest},Kn=new dt;function yt(a){return encodeURIComponent(String(a))}function Ns(a){var h=1;a=a.split(":");const d=[];for(;h>0&&a.length;)d.push(a.shift()),h--;return a.length&&d.push(a.join(":")),d}function nt(a,h,d,_){this.j=a,this.i=h,this.l=d,this.S=_||1,this.V=new Je(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Mt}function Mt(){this.i=null,this.g="",this.h=!1}var Pp={},Ec={};function Tc(a,h,d){a.M=1,a.A=qa(Qn(h)),a.u=d,a.R=!0,Np(a,null)}function Np(a,h){a.F=Date.now(),Ha(a),a.B=Qn(a.A);var d=a.B,_=a.S;Array.isArray(_)||(_=[String(_)]),Hp(d.i,"t",_),a.C=0,d=a.j.L,a.h=new Mt,a.g=lm(a.j,d?h:null,!a.u),a.P>0&&(a.O=new je(c(a.Y,a,a.g),a.P)),h=a.V,d=a.g,_=a.ba;var R="readystatechange";Array.isArray(R)||(R&&(Ue[0]=R.toString()),R=Ue);for(let b=0;b<R.length;b++){const q=Ct(d,R[b],_||h.handleEvent,!1,h.h||h);if(!q)break;h.g[q.key]=q}h=a.J?he(a.J):{},a.u?(a.v||(a.v="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,h)):(a.v="GET",a.g.ea(a.B,a.v,null,h)),De(),Ce(a.i,a.v,a.B,a.l,a.S,a.u)}nt.prototype.ba=function(a){a=a.target;const h=this.O;h&&zr(a)==3?h.j():this.Y(a)},nt.prototype.Y=function(a){try{if(a==this.g)e:{const me=zr(this.g),It=this.g.ya(),Fe=this.g.ca();if(!(me<3)&&(me!=3||this.g&&(this.h.h||this.g.la()||Yp(this.g)))){this.K||me!=4||It==7||(It==8||Fe<=0?De(3):De(2)),Ic(this);var h=this.g.ca();this.X=h;var d=h1(this);if(this.o=h==200,Oe(this.i,this.v,this.B,this.l,this.S,me,h),this.o){if(this.U&&!this.L){t:{if(this.g){var _,R=this.g;if((_=R.g?R.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!T(_)){var b=_;break t}}b=null}if(a=b)Ee(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Sc(this,a);else{this.o=!1,this.m=3,ke(12),bs(this),ho(this);break e}}if(this.R){a=!0;let Pt;for(;!this.K&&this.C<d.length;)if(Pt=d1(this,d),Pt==Ec){me==4&&(this.m=4,ke(14),a=!1),Ee(this.i,this.l,null,"[Incomplete Response]");break}else if(Pt==Pp){this.m=4,ke(15),Ee(this.i,this.l,d,"[Invalid Chunk]"),a=!1;break}else Ee(this.i,this.l,Pt,null),Sc(this,Pt);if(bp(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),me!=4||d.length!=0||this.h.h||(this.m=1,ke(16),a=!1),this.o=this.o&&a,!a)Ee(this.i,this.l,d,"[Invalid Chunked Response]"),bs(this),ho(this);else if(d.length>0&&!this.W){this.W=!0;var q=this.j;q.g==this&&q.aa&&!q.P&&(q.j.info("Great, no buffering proxy detected. Bytes received: "+d.length),bc(q),q.P=!0,ke(11))}}else Ee(this.i,this.l,d,null),Sc(this,d);me==4&&bs(this),this.o&&!this.K&&(me==4?sm(this.j,this):(this.o=!1,Ha(this)))}else A1(this.g),h==400&&d.indexOf("Unknown SID")>0?(this.m=3,ke(12)):(this.m=0,ke(13)),bs(this),ho(this)}}}catch{}finally{}};function h1(a){if(!bp(a))return a.g.la();const h=Yp(a.g);if(h==="")return"";let d="";const _=h.length,R=zr(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return bs(a),ho(a),"";a.h.i=new o.TextDecoder}for(let b=0;b<_;b++)a.h.h=!0,d+=a.h.i.decode(h[b],{stream:!(R&&b==_-1)});return h.length=0,a.h.g+=d,a.C=0,a.h.g}function bp(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function d1(a,h){var d=a.C,_=h.indexOf(`
`,d);return _==-1?Ec:(d=Number(h.substring(d,_)),isNaN(d)?Pp:(_+=1,_+d>h.length?Ec:(h=h.slice(_,_+d),a.C=_+d,h)))}nt.prototype.cancel=function(){this.K=!0,bs(this)};function Ha(a){a.T=Date.now()+a.H,Dp(a,a.H)}function Dp(a,h){if(a.D!=null)throw Error("WatchDog timer not null");a.D=Se(c(a.aa,a),h)}function Ic(a){a.D&&(o.clearTimeout(a.D),a.D=null)}nt.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(ht(this.i,this.B),this.M!=2&&(De(),ke(17)),bs(this),this.m=2,ho(this)):Dp(this,this.T-a)};function ho(a){a.j.I==0||a.K||sm(a.j,a)}function bs(a){Ic(a);var h=a.O;h&&typeof h.dispose=="function"&&h.dispose(),a.O=null,be(a.V),a.g&&(h=a.g,a.g=null,h.abort(),h.dispose())}function Sc(a,h){try{var d=a.j;if(d.I!=0&&(d.g==a||xc(d.h,a))){if(!a.L&&xc(d.h,a)&&d.I==3){try{var _=d.Ba.g.parse(h)}catch{_=null}if(Array.isArray(_)&&_.length==3){var R=_;if(R[0]==0){e:if(!d.v){if(d.g)if(d.g.F+3e3<a.F)Ja(d),Ka(d);else break e;Nc(d),ke(18)}}else d.xa=R[1],0<d.xa-d.K&&R[2]<37500&&d.F&&d.A==0&&!d.C&&(d.C=Se(c(d.Va,d),6e3));Mp(d.h)<=1&&d.ta&&(d.ta=void 0)}else Os(d,11)}else if((a.L||d.g==a)&&Ja(d),!T(h))for(R=d.Ba.g.parse(h),h=0;h<R.length;h++){let Fe=R[h];const Pt=Fe[0];if(!(Pt<=d.K))if(d.K=Pt,Fe=Fe[1],d.I==2)if(Fe[0]=="c"){d.M=Fe[1],d.ba=Fe[2];const Jn=Fe[3];Jn!=null&&(d.ka=Jn,d.j.info("VER="+d.ka));const Vs=Fe[4];Vs!=null&&(d.za=Vs,d.j.info("SVER="+d.za));const Br=Fe[5];Br!=null&&typeof Br=="number"&&Br>0&&(_=1.5*Br,d.O=_,d.j.info("backChannelRequestTimeoutMs_="+_)),_=d;const Hr=a.g;if(Hr){const Xa=Hr.g?Hr.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Xa){var b=_.h;b.g||Xa.indexOf("spdy")==-1&&Xa.indexOf("quic")==-1&&Xa.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(Ac(b,b.h),b.h=null))}if(_.G){const Dc=Hr.g?Hr.g.getResponseHeader("X-HTTP-Session-Id"):null;Dc&&(_.wa=Dc,He(_.J,_.G,Dc))}}d.I=3,d.l&&d.l.ra(),d.aa&&(d.T=Date.now()-a.F,d.j.info("Handshake RTT: "+d.T+"ms")),_=d;var q=a;if(_.na=am(_,_.L?_.ba:null,_.W),q.L){Lp(_.h,q);var me=q,It=_.O;It&&(me.H=It),me.D&&(Ic(me),Ha(me)),_.g=q}else nm(_);d.i.length>0&&Qa(d)}else Fe[0]!="stop"&&Fe[0]!="close"||Os(d,7);else d.I==3&&(Fe[0]=="stop"||Fe[0]=="close"?Fe[0]=="stop"?Os(d,7):Pc(d):Fe[0]!="noop"&&d.l&&d.l.qa(Fe),d.A=0)}}De(4)}catch{}}var f1=class{constructor(a,h){this.g=a,this.map=h}};function Op(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Vp(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Mp(a){return a.h?1:a.g?a.g.size:0}function xc(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function Ac(a,h){a.g?a.g.add(h):a.h=h}function Lp(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}Op.prototype.cancel=function(){if(this.i=jp(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function jp(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const d of a.g.values())h=h.concat(d.G);return h}return k(a.i)}var Up=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function p1(a,h){if(a){a=a.split("&");for(let d=0;d<a.length;d++){const _=a[d].indexOf("=");let R,b=null;_>=0?(R=a[d].substring(0,_),b=a[d].substring(_+1)):R=a[d],h(R,b?decodeURIComponent(b.replace(/\+/g," ")):"")}}}function Fr(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let h;a instanceof Fr?(this.l=a.l,fo(this,a.j),this.o=a.o,this.g=a.g,po(this,a.u),this.h=a.h,kc(this,qp(a.i)),this.m=a.m):a&&(h=String(a).match(Up))?(this.l=!1,fo(this,h[1]||"",!0),this.o=mo(h[2]||""),this.g=mo(h[3]||"",!0),po(this,h[4]),this.h=mo(h[5]||"",!0),kc(this,h[6]||"",!0),this.m=mo(h[7]||"")):(this.l=!1,this.i=new yo(null,this.l))}Fr.prototype.toString=function(){const a=[];var h=this.j;h&&a.push(go(h,Fp,!0),":");var d=this.g;return(d||h=="file")&&(a.push("//"),(h=this.o)&&a.push(go(h,Fp,!0),"@"),a.push(yt(d).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.u,d!=null&&a.push(":",String(d))),(d=this.h)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(go(d,d.charAt(0)=="/"?y1:g1,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",go(d,v1)),a.join("")},Fr.prototype.resolve=function(a){const h=Qn(this);let d=!!a.j;d?fo(h,a.j):d=!!a.o,d?h.o=a.o:d=!!a.g,d?h.g=a.g:d=a.u!=null;var _=a.h;if(d)po(h,a.u);else if(d=!!a.h){if(_.charAt(0)!="/")if(this.g&&!this.h)_="/"+_;else{var R=h.h.lastIndexOf("/");R!=-1&&(_=h.h.slice(0,R+1)+_)}if(R=_,R==".."||R==".")_="";else if(R.indexOf("./")!=-1||R.indexOf("/.")!=-1){_=R.lastIndexOf("/",0)==0,R=R.split("/");const b=[];for(let q=0;q<R.length;){const me=R[q++];me=="."?_&&q==R.length&&b.push(""):me==".."?((b.length>1||b.length==1&&b[0]!="")&&b.pop(),_&&q==R.length&&b.push("")):(b.push(me),_=!0)}_=b.join("/")}else _=R}return d?h.h=_:d=a.i.toString()!=="",d?kc(h,qp(a.i)):d=!!a.m,d&&(h.m=a.m),h};function Qn(a){return new Fr(a)}function fo(a,h,d){a.j=d?mo(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function po(a,h){if(h){if(h=Number(h),isNaN(h)||h<0)throw Error("Bad port number "+h);a.u=h}else a.u=null}function kc(a,h,d){h instanceof yo?(a.i=h,w1(a.i,a.l)):(d||(h=go(h,_1)),a.i=new yo(h,a.l))}function He(a,h,d){a.i.set(h,d)}function qa(a){return He(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function mo(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function go(a,h,d){return typeof a=="string"?(a=encodeURI(a).replace(h,m1),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function m1(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Fp=/[#\/\?@]/g,g1=/[#\?:]/g,y1=/[#\?]/g,_1=/[#\?@]/g,v1=/#/g;function yo(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Ds(a){a.g||(a.g=new Map,a.h=0,a.i&&p1(a.i,function(h,d){a.add(decodeURIComponent(h.replace(/\+/g," ")),d)}))}t=yo.prototype,t.add=function(a,h){Ds(this),this.i=null,a=fi(this,a);let d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(h),this.h+=1,this};function $p(a,h){Ds(a),h=fi(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function zp(a,h){return Ds(a),h=fi(a,h),a.g.has(h)}t.forEach=function(a,h){Ds(this),this.g.forEach(function(d,_){d.forEach(function(R){a.call(h,R,_,this)},this)},this)};function Bp(a,h){Ds(a);let d=[];if(typeof h=="string")zp(a,h)&&(d=d.concat(a.g.get(fi(a,h))));else for(a=Array.from(a.g.values()),h=0;h<a.length;h++)d=d.concat(a[h]);return d}t.set=function(a,h){return Ds(this),this.i=null,a=fi(this,a),zp(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},t.get=function(a,h){return a?(a=Bp(this,a),a.length>0?String(a[0]):h):h};function Hp(a,h,d){$p(a,h),d.length>0&&(a.i=null,a.g.set(fi(a,h),k(d)),a.h+=d.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(let _=0;_<h.length;_++){var d=h[_];const R=yt(d);d=Bp(this,d);for(let b=0;b<d.length;b++){let q=R;d[b]!==""&&(q+="="+yt(d[b])),a.push(q)}}return this.i=a.join("&")};function qp(a){const h=new yo;return h.i=a.i,a.g&&(h.g=new Map(a.g),h.h=a.h),h}function fi(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function w1(a,h){h&&!a.j&&(Ds(a),a.i=null,a.g.forEach(function(d,_){const R=_.toLowerCase();_!=R&&($p(this,_),Hp(this,R,d))},a)),a.j=h}function E1(a,h){const d=new Pe;if(o.Image){const _=new Image;_.onload=f($r,d,"TestLoadImage: loaded",!0,h,_),_.onerror=f($r,d,"TestLoadImage: error",!1,h,_),_.onabort=f($r,d,"TestLoadImage: abort",!1,h,_),_.ontimeout=f($r,d,"TestLoadImage: timeout",!1,h,_),o.setTimeout(function(){_.ontimeout&&_.ontimeout()},1e4),_.src=a}else h(!1)}function T1(a,h){const d=new Pe,_=new AbortController,R=setTimeout(()=>{_.abort(),$r(d,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:_.signal}).then(b=>{clearTimeout(R),b.ok?$r(d,"TestPingServer: ok",!0,h):$r(d,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(R),$r(d,"TestPingServer: error",!1,h)})}function $r(a,h,d,_,R){try{R&&(R.onload=null,R.onerror=null,R.onabort=null,R.ontimeout=null),_(d)}catch{}}function I1(){this.g=new Ur}function Cc(a){this.i=a.Sb||null,this.h=a.ab||!1}p(Cc,Rt),Cc.prototype.g=function(){return new Wa(this.i,this.h)};function Wa(a,h){W.call(this),this.H=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(Wa,W),t=Wa.prototype,t.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=h,this.readyState=1,vo(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const h={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(h.body=a),(this.H||o).fetch(new Request(this.D,h)).then(this.Pa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,_o(this)),this.readyState=0},t.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,vo(this)),this.g&&(this.readyState=3,vo(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Wp(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function Wp(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}t.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.B.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?_o(this):vo(this),this.readyState==3&&Wp(this)}},t.Oa=function(a){this.g&&(this.response=this.responseText=a,_o(this))},t.Na=function(a){this.g&&(this.response=a,_o(this))},t.ga=function(){this.g&&_o(this)};function _o(a){a.readyState=4,a.l=null,a.j=null,a.B=null,vo(a)}t.setRequestHeader=function(a,h){this.A.append(a,h)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var d=h.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=h.next();return a.join(`\r
`)};function vo(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Wa.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Gp(a){let h="";return Y(a,function(d,_){h+=_,h+=":",h+=d,h+=`\r
`}),h}function Rc(a,h,d){e:{for(_ in d){var _=!1;break e}_=!0}_||(d=Gp(d),typeof a=="string"?d!=null&&yt(d):He(a,h,d))}function at(a){W.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(at,W);var S1=/^https?$/i,x1=["POST","PUT"];t=at.prototype,t.Fa=function(a){this.H=a},t.ea=function(a,h,d,_){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Kn.g(),this.g.onreadystatechange=v(c(this.Ca,this));try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(b){Kp(this,b);return}if(a=d||"",d=new Map(this.headers),_)if(Object.getPrototypeOf(_)===Object.prototype)for(var R in _)d.set(R,_[R]);else if(typeof _.keys=="function"&&typeof _.get=="function")for(const b of _.keys())d.set(b,_.get(b));else throw Error("Unknown input type for opt_headers: "+String(_));_=Array.from(d.keys()).find(b=>b.toLowerCase()=="content-type"),R=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(x1,h,void 0)>=0)||_||R||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,q]of d)this.g.setRequestHeader(b,q);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(b){Kp(this,b)}};function Kp(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.o=5,Qp(a),Ga(a)}function Qp(a){a.A||(a.A=!0,G(a,"complete"),G(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,G(this,"complete"),G(this,"abort"),Ga(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ga(this,!0)),at.Z.N.call(this)},t.Ca=function(){this.u||(this.B||this.v||this.j?Jp(this):this.Xa())},t.Xa=function(){Jp(this)};function Jp(a){if(a.h&&typeof i<"u"){if(a.v&&zr(a)==4)setTimeout(a.Ca.bind(a),0);else if(G(a,"readystatechange"),zr(a)==4){a.h=!1;try{const b=a.ca();e:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var d;if(!(d=h)){var _;if(_=b===0){let q=String(a.D).match(Up)[1]||null;!q&&o.self&&o.self.location&&(q=o.self.location.protocol.slice(0,-1)),_=!S1.test(q?q.toLowerCase():"")}d=_}if(d)G(a,"complete"),G(a,"success");else{a.o=6;try{var R=zr(a)>2?a.g.statusText:""}catch{R=""}a.l=R+" ["+a.ca()+"]",Qp(a)}}finally{Ga(a)}}}}function Ga(a,h){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const d=a.g;a.g=null,h||G(a,"ready");try{d.onreadystatechange=null}catch{}}}t.isActive=function(){return!!this.g};function zr(a){return a.g?a.g.readyState:0}t.ca=function(){try{return zr(this)>2?this.g.status:-1}catch{return-1}},t.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.La=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),tt(h)}};function Yp(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function A1(a){const h={};a=(a.g&&zr(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let _=0;_<a.length;_++){if(T(a[_]))continue;var d=Ns(a[_]);const R=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const b=h[R]||[];h[R]=b,b.push(d)}B(h,function(_){return _.join(", ")})}t.ya=function(){return this.o},t.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function wo(a,h,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||h}function Xp(a){this.za=0,this.i=[],this.j=new Pe,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=wo("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=wo("baseRetryDelayMs",5e3,a),this.Za=wo("retryDelaySeedMs",1e4,a),this.Ta=wo("forwardChannelMaxRetries",2,a),this.va=wo("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new Op(a&&a.concurrentRequestLimit),this.Ba=new I1,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}t=Xp.prototype,t.ka=8,t.I=1,t.connect=function(a,h,d,_){ke(0),this.W=a,this.H=h||{},d&&_!==void 0&&(this.H.OSID=d,this.H.OAID=_),this.F=this.X,this.J=am(this,null,this.W),Qa(this)};function Pc(a){if(Zp(a),a.I==3){var h=a.V++,d=Qn(a.J);if(He(d,"SID",a.M),He(d,"RID",h),He(d,"TYPE","terminate"),Eo(a,d),h=new nt(a,a.j,h),h.M=2,h.A=qa(Qn(d)),d=!1,o.navigator&&o.navigator.sendBeacon)try{d=o.navigator.sendBeacon(h.A.toString(),"")}catch{}!d&&o.Image&&(new Image().src=h.A,d=!0),d||(h.g=lm(h.j,null),h.g.ea(h.A)),h.F=Date.now(),Ha(h)}om(a)}function Ka(a){a.g&&(bc(a),a.g.cancel(),a.g=null)}function Zp(a){Ka(a),a.v&&(o.clearTimeout(a.v),a.v=null),Ja(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function Qa(a){if(!Vp(a.h)&&!a.m){a.m=!0;var h=a.Ea;L||y(),U||(L(),U=!0),g.add(h,a),a.D=0}}function k1(a,h){return Mp(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=h.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=Se(c(a.Ea,a,h),im(a,a.D)),a.D++,!0)}t.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const R=new nt(this,this.j,a);let b=this.o;if(this.U&&(b?(b=he(b),Qe(b,this.U)):b=this.U),this.u!==null||this.R||(R.J=b,b=null),this.S)e:{for(var h=0,d=0;d<this.i.length;d++){t:{var _=this.i[d];if("__data__"in _.map&&(_=_.map.__data__,typeof _=="string")){_=_.length;break t}_=void 0}if(_===void 0)break;if(h+=_,h>4096){h=d;break e}if(h===4096||d===this.i.length-1){h=d+1;break e}}h=1e3}else h=1e3;h=tm(this,R,h),d=Qn(this.J),He(d,"RID",a),He(d,"CVER",22),this.G&&He(d,"X-HTTP-Session-Id",this.G),Eo(this,d),b&&(this.R?h="headers="+yt(Gp(b))+"&"+h:this.u&&Rc(d,this.u,b)),Ac(this.h,R),this.Ra&&He(d,"TYPE","init"),this.S?(He(d,"$req",h),He(d,"SID","null"),R.U=!0,Tc(R,d,null)):Tc(R,d,h),this.I=2}}else this.I==3&&(a?em(this,a):this.i.length==0||Vp(this.h)||em(this))};function em(a,h){var d;h?d=h.l:d=a.V++;const _=Qn(a.J);He(_,"SID",a.M),He(_,"RID",d),He(_,"AID",a.K),Eo(a,_),a.u&&a.o&&Rc(_,a.u,a.o),d=new nt(a,a.j,d,a.D+1),a.u===null&&(d.J=a.o),h&&(a.i=h.G.concat(a.i)),h=tm(a,d,1e3),d.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),Ac(a.h,d),Tc(d,_,h)}function Eo(a,h){a.H&&Y(a.H,function(d,_){He(h,_,d)}),a.l&&Y({},function(d,_){He(h,_,d)})}function tm(a,h,d){d=Math.min(a.i.length,d);const _=a.l?c(a.l.Ka,a.l,a):null;e:{var R=a.i;let me=-1;for(;;){const It=["count="+d];me==-1?d>0?(me=R[0].g,It.push("ofs="+me)):me=0:It.push("ofs="+me);let Fe=!0;for(let Pt=0;Pt<d;Pt++){var b=R[Pt].g;const Jn=R[Pt].map;if(b-=me,b<0)me=Math.max(0,R[Pt].g-100),Fe=!1;else try{b="req"+b+"_"||"";try{var q=Jn instanceof Map?Jn:Object.entries(Jn);for(const[Vs,Br]of q){let Hr=Br;l(Br)&&(Hr=et(Br)),It.push(b+Vs+"="+encodeURIComponent(Hr))}}catch(Vs){throw It.push(b+"type="+encodeURIComponent("_badmap")),Vs}}catch{_&&_(Jn)}}if(Fe){q=It.join("&");break e}}q=void 0}return a=a.i.splice(0,d),h.G=a,q}function nm(a){if(!a.g&&!a.v){a.Y=1;var h=a.Da;L||y(),U||(L(),U=!0),g.add(h,a),a.A=0}}function Nc(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=Se(c(a.Da,a),im(a,a.A)),a.A++,!0)}t.Da=function(){if(this.v=null,rm(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=Se(c(this.Wa,this),a)}},t.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ke(10),Ka(this),rm(this))};function bc(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function rm(a){a.g=new nt(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var h=Qn(a.na);He(h,"RID","rpc"),He(h,"SID",a.M),He(h,"AID",a.K),He(h,"CI",a.F?"0":"1"),!a.F&&a.ia&&He(h,"TO",a.ia),He(h,"TYPE","xmlhttp"),Eo(a,h),a.u&&a.o&&Rc(h,a.u,a.o),a.O&&(a.g.H=a.O);var d=a.g;a=a.ba,d.M=1,d.A=qa(Qn(h)),d.u=null,d.R=!0,Np(d,a)}t.Va=function(){this.C!=null&&(this.C=null,Ka(this),Nc(this),ke(19))};function Ja(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function sm(a,h){var d=null;if(a.g==h){Ja(a),bc(a),a.g=null;var _=2}else if(xc(a.h,h))d=h.G,Lp(a.h,h),_=1;else return;if(a.I!=0){if(h.o)if(_==1){d=h.u?h.u.length:0,h=Date.now()-h.F;var R=a.D;_=Re(),G(_,new Ie(_,d)),Qa(a)}else nm(a);else if(R=h.m,R==3||R==0&&h.X>0||!(_==1&&k1(a,h)||_==2&&Nc(a)))switch(d&&d.length>0&&(h=a.h,h.i=h.i.concat(d)),R){case 1:Os(a,5);break;case 4:Os(a,10);break;case 3:Os(a,6);break;default:Os(a,2)}}}function im(a,h){let d=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(d*=2),d*h}function Os(a,h){if(a.j.info("Error code "+h),h==2){var d=c(a.bb,a),_=a.Ua;const R=!_;_=new Fr(_||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||fo(_,"https"),qa(_),R?E1(_.toString(),d):T1(_.toString(),d)}else ke(2);a.I=0,a.l&&a.l.pa(h),om(a),Zp(a)}t.bb=function(a){a?(this.j.info("Successfully pinged google.com"),ke(2)):(this.j.info("Failed to ping google.com"),ke(1))};function om(a){if(a.I=0,a.ja=[],a.l){const h=jp(a.h);(h.length!=0||a.i.length!=0)&&(P(a.ja,h),P(a.ja,a.i),a.h.i.length=0,k(a.i),a.i.length=0),a.l.oa()}}function am(a,h,d){var _=d instanceof Fr?Qn(d):new Fr(d);if(_.g!="")h&&(_.g=h+"."+_.g),po(_,_.u);else{var R=o.location;_=R.protocol,h=h?h+"."+R.hostname:R.hostname,R=+R.port;const b=new Fr(null);_&&fo(b,_),h&&(b.g=h),R&&po(b,R),d&&(b.h=d),_=b}return d=a.G,h=a.wa,d&&h&&He(_,d,h),He(_,"VER",a.ka),Eo(a,_),_}function lm(a,h,d){if(h&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Aa&&!a.ma?new at(new Cc({ab:d})):new at(a.ma),h.Fa(a.L),h}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function um(){}t=um.prototype,t.ra=function(){},t.qa=function(){},t.pa=function(){},t.oa=function(){},t.isActive=function(){return!0},t.Ka=function(){};function Ya(){}Ya.prototype.g=function(a,h){return new mn(a,h)};function mn(a,h){W.call(this),this.g=new Xp(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.sa&&(a?a["X-WebChannel-Client-Profile"]=h.sa:a={"X-WebChannel-Client-Profile":h.sa}),this.g.U=a,(a=h&&h.Qb)&&!T(a)&&(this.g.u=a),this.A=h&&h.supportsCrossDomainXhr||!1,this.v=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!T(h)&&(this.g.G=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new pi(this)}p(mn,W),mn.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},mn.prototype.close=function(){Pc(this.g)},mn.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.v&&(d={},d.__data__=et(a),a=d);h.i.push(new f1(h.Ya++,a)),h.I==3&&Qa(h)},mn.prototype.N=function(){this.g.l=null,delete this.j,Pc(this.g),delete this.g,mn.Z.N.call(this)};function cm(a){di.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const d in h){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}p(cm,di);function hm(){Ps.call(this),this.status=1}p(hm,Ps);function pi(a){this.g=a}p(pi,um),pi.prototype.ra=function(){G(this.g,"a")},pi.prototype.qa=function(a){G(this.g,new cm(a))},pi.prototype.pa=function(a){G(this.g,new hm)},pi.prototype.oa=function(){G(this.g,"b")},Ya.prototype.createWebChannel=Ya.prototype.g,mn.prototype.send=mn.prototype.o,mn.prototype.open=mn.prototype.m,mn.prototype.close=mn.prototype.close,Tw=function(){return new Ya},Ew=function(){return Re()},ww=yr,Td={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Le.NO_ERROR=0,Le.TIMEOUT=8,Le.HTTP_ERROR=6,zl=Le,Wt.COMPLETE="complete",vw=Wt,bn.EventType=gr,gr.OPEN="a",gr.CLOSE="b",gr.ERROR="c",gr.MESSAGE="d",W.prototype.listen=W.prototype.J,Mo=bn,at.prototype.listenOnce=at.prototype.K,at.prototype.getLastError=at.prototype.Ha,at.prototype.getLastErrorCode=at.prototype.ya,at.prototype.getStatus=at.prototype.ca,at.prototype.getResponseJson=at.prototype.La,at.prototype.getResponseText=at.prototype.la,at.prototype.send=at.prototype.ea,at.prototype.setWithCredentials=at.prototype.Fa,_w=at}).apply(typeof _l<"u"?_l:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OC{constructor(e,n,r,s,i,o,l,u,c,f,p){this.databaseId=e,this.appId=n,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=o,this.autoDetectLongPolling=l,this.longPollingOptions=u,this.useFetchStreams=c,this.isUsingEmulator=f,this.apiKey=p}}const Pu="(default)";class Ea{constructor(e,n){this.projectId=e,this.database=n||Pu}static empty(){return new Ea("","")}get isDefaultDatabase(){return this.database===Pu}isEqual(e){return e instanceof Ea&&e.projectId===this.projectId&&e.database===this.database}}function VC(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new J(j.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ea(t.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ua{constructor(e,n,r,s,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const s=new Map;return s.set(e,Fa.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Ua(ae.min(),s,new Xe(_e),Lr(),ve())}}class Fa{constructor(e,n,r,s,i){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new Fa(r,n,ve(),ve(),ve())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JR{constructor(e,n,r,s){this.remoteDocumentCache=e,this.mutationQueue=n,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,n){let r=null;return this.documentOverlayCache.getOverlay(e,n).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,n))).next(s=>(r!==null&&Zo(r.mutation,s,$n.empty(),Ge.now()),s))}getDocuments(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.getLocalViewOfDocuments(e,r,ve()).next(()=>r))}getLocalViewOfDocuments(e,n,r=ve()){const s=Bs();return this.populateOverlays(e,s,n).next(()=>this.computeViews(e,n,s,r).next(i=>{let o=Lo();return i.forEach((l,u)=>{o=o.insert(l,u.overlayedDocument)}),o}))}getOverlayedDocuments(e,n){const r=Bs();return this.populateOverlays(e,r,n).next(()=>this.computeViews(e,n,r,ve()))}populateOverlays(e,n,r){const s=[];return r.forEach(i=>{n.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(e,s).next(i=>{i.forEach((o,l)=>{n.set(o,l)})})}computeViews(e,n,r,s){let i=Lr();const o=Xo(),l=function(){return Xo()}();return n.forEach((u,c)=>{const f=r.get(c.key);s.has(c.key)&&(f===void 0||f.mutation instanceof ci)?i=i.insert(c.key,c):f!==void 0?(o.set(c.key,f.mutation.getFieldMask()),Zo(f.mutation,c,f.mutation.getFieldMask(),Ge.now())):o.set(c.key,$n.empty())}),this.recalculateAndSaveOverlays(e,i).next(u=>(u.forEach((c,f)=>o.set(c,f)),n.forEach((c,f)=>l.set(c,new QR(f,o.get(c)??null))),l))}recalculateAndSaveOverlays(e,n){const r=Xo();let s=new Xe((o,l)=>o-l),i=ve();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,n).next(o=>{for(const l of o)l.keys().forEach(u=>{const c=n.get(u);if(c===null)return;let f=r.get(u)||$n.empty();f=l.applyToLocalView(c,f),r.set(u,f);const p=(s.get(l.batchId)||ve()).add(u);s=s.insert(l.batchId,p)})}).next(()=>{const o=[],l=s.getReverseIterator();for(;l.hasNext();){const u=l.getNext(),c=u.key,f=u.value,p=Gw();f.forEach(v=>{if(!i.has(v)){const k=Zw(n.get(v),r.get(v));k!==null&&p.set(v,k),i=i.add(v)}}),o.push(this.documentOverlayCache.saveOverlays(e,c,p))}return M.waitFor(o)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,n,r,s){return JC(n)?this.getDocumentsMatchingDocumentQuery(e,n.path):YC(n)?this.getDocumentsMatchingCollectionGroupQuery(e,n,r,s):this.getDocumentsMatchingCollectionQuery(e,n,r,s)}getNextDocuments(e,n,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,n,r,s).next(i=>{const o=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,n,r.largestBatchId,s-i.size):M.resolve(Bs());let l=va,u=i;return o.next(c=>M.forEach(c,(f,p)=>(l<p.largestBatchId&&(l=p.largestBatchId),i.get(f)?M.resolve():this.remoteDocumentCache.getEntry(e,f).next(v=>{u=u.insert(f,v)}))).next(()=>this.populateOverlays(e,c,i)).next(()=>this.computeViews(e,u,c,ve())).next(f=>({batchId:l,changes:Ww(f)})))})}getDocumentsMatchingDocumentQuery(e,n){return this.getDocument(e,new ne(n)).next(r=>{let s=Lo();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,n,r,s){const i=n.collectionGroup;let o=Lo();return this.indexManager.getCollectionParents(e,i).next(l=>M.forEach(l,u=>{const c=function(p,v){return new cc(v,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)}(n,u.child(i));return this.getDocumentsMatchingCollectionQuery(e,c,r,s).next(f=>{f.forEach((p,v)=>{o=o.insert(p,v)})})}).next(()=>o))}getDocumentsMatchingCollectionQuery(e,n,r,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,n.path,r.largestBatchId).next(o=>(i=o,this.remoteDocumentCache.getDocumentsMatchingQuery(e,n,r,i,s))).next(o=>{i.forEach((u,c)=>{const f=c.getKey();o.get(f)===null&&(o=o.insert(f,Xt.newInvalidDocument(f)))});let l=Lo();return o.forEach((u,c)=>{const f=i.get(u);f!==void 0&&Zo(f.mutation,c,$n.empty(),Ge.now()),fc(n,c)&&(l=l.insert(u,c))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XR{constructor(){this.overlays=new Xe(ne.comparator),this.Lr=new Map}getOverlay(e,n){return M.resolve(this.overlays.get(n))}getOverlays(e,n){const r=Bs();return M.forEach(n,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,n,r){return r.forEach((s,i)=>{this.St(e,n,i)}),M.resolve()}removeOverlaysForBatchId(e,n,r){const s=this.Lr.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.Lr.delete(r)),M.resolve()}getOverlaysForCollection(e,n,r){const s=Bs(),i=n.length+1,o=new ne(n.child("")),l=this.overlays.getIteratorFrom(o);for(;l.hasNext();){const u=l.getNext().value,c=u.getKey();if(!n.isPrefixOf(c.path))break;c.path.length===i&&u.largestBatchId>r&&s.set(u.getKey(),u)}return M.resolve(s)}getOverlaysForCollectionGroup(e,n,r,s){let i=new Xe((c,f)=>c-f);const o=this.overlays.getIterator();for(;o.hasNext();){const c=o.getNext().value;if(c.getKey().getCollectionGroup()===n&&c.largestBatchId>r){let f=i.get(c.largestBatchId);f===null&&(f=Bs(),i=i.insert(c.largestBatchId,f)),f.set(c.getKey(),c)}}const l=Bs(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((c,f)=>l.set(c,f)),!(l.size()>=s)););return M.resolve(l)}St(e,n,r){const s=this.overlays.get(r.key);if(s!==null){const o=this.Lr.get(s.largestBatchId).delete(r.key);this.Lr.set(s.largestBatchId,o)}this.overlays=this.overlays.insert(r.key,new gR(n,r));let i=this.Lr.get(n);i===void 0&&(i=ve(),this.Lr.set(n,i)),this.Lr.set(n,i.add(r.key))}}/**
 * @license
