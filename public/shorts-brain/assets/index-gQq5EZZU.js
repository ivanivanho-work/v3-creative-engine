...
*/var hs,gw;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,p){function v(){}v.prototype=p.prototype,E.F=p.prototype,E.prototype=new v,E.prototype.constructor=E,E.D=function(w,T,C){for(var S=Array(arguments.length-2),ee=2;ee<arguments.length;ee++)S[ee-2]=arguments[ee];return p.prototype[T].apply(w,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(E,p,v){v||(v=0);const w=Array(16);if(typeof p=="string")for(var T=0;T<16;++T)w[T]=p.charCodeAt(v++)|p.charCodeAt(v++)<<8|p.charCodeAt(v++)<<16|p.charCodeAt(v++)<<24;else for(T=0;T<16;++T)w[T]=p[v++]|p[v++]<<8|p[v++]<<16|p[v++]<<24;p=E.g[0],v=E.g[1],T=E.g[2];let C=E.g[3],S;S=p+(C^v&(T^C))+w[0]+3614090360&4294967295,p=v+(S<<7&4294967295|S>>>25),S=C+(T^p&(v^T))+w[1]+3905402710&4294967295,C=p+(S<<12&4294967295|S>>>20),S=T+(v^C&(p^v))+w[2]+606105819&4294967295,T=C+(S<<17&4294967295|S>>>15),S=v+(p^T&(C^p))+w[3]+3250441966&4294967295,v=T+(S<<22&4294967295|S>>>10),S=p+(C^v&(T^C))+w[4]+4118548399&4294967295,p=v+(S<<7&4294967295|S>>>25),S=C+(T^p&(v^T))+w[5]+1200080426&4294967295,C=p+(S<<12&4294967295|S>>>20),S=T+(v^C&(p^v))+w[6]+2821735955&4294967295,T=C+(S<<17&4294967295|S>>>15),S=v+(p^T&(C^p))+w[7]+4249261313&4294967295,v=T+(S<<22&4294967295|S>>>10),S=p+(C^v&(T^C))+w[8]+1770035416&4294967295,p=v+(S<<7&4294967295|S>>>25),S=C+(T^p&(v^T))+w[9]+2336552879&4294967295,C=p+(S<<12&4294967295|S>>>20),S=T+(v^C&(p^v))+w[10]+4294925233&4294967295,T=C+(S<<17&4294967295|S>>>15),S=v+(p^T&(C^p))+w[11]+2304563134&4294967295,v=T+(S<<22&4294967295|S>>>10),S=p+(C^v&(T^C))+w[12]+1804603682&4294967295,p=v+(S<<7&4294967295|S>>>25),S=C+(T^p&(v^T))+w[13]+4254626195&4294967295,C=p+(S<<12&4294967295|S>>>20),S=T+(v^C&(p^v))+w[14]+2792965006&4294967295,T=C+(S<<17&4294967295|S>>>15),S=v+(p^T&(C^p))+w[15]+1236535329&4294967295,v=T+(S<<22&4294967295|S>>>10),S=p+(T^C&(v^T))+w[1]+4129170786&4294967295,p=v+(S<<5&4294967295|S>>>27),S=C+(v^T&(p^v))+w[6]+3225465664&4294967295,C=p+(S<<9&4294967295|S>>>23),S=T+(p^v&(C^p))+w[11]+643717713&4294967295,T=C+(S<<14&4294967295|S>>>18),S=v+(C^p&(T^C))+w[0]+3921069994&4294967295,v=T+(S<<20&4294967295|S>>>12),S=p+(T^C&(v^T))+w[5]+3593408605&4294967295,p=v+(S<<5&4294967295|S>>>27),S=C+(v^T&(p^v))+w[10]+38016083&4294967295,C=p+(S<<9&4294967295|S>>>23),S=T+(p^v&(C^p))+w[15]+3634488961&4294967295,T=C+(S<<14&4294967295|S>>>18),S=v+(C^p&(T^C))+w[4]+3889429448&4294967295,v=T+(S<<20&4294967295|S>>>12),S=p+(T^C&(v^T))+w[9]+568446438&4294967295,p=v+(S<<5&4294967295|S>>>27),S=C+(v^T&(p^v))+w[14]+3275163606&4294967295,C=p+(S<<9&4294967295|S>>>23),S=T+(p^v&(C^p))+w[3]+4107603335&4294967295,T=C+(S<<14&4294967295|S>>>18),S=v+(C^p&(T^C))+w[8]+1163531501&4294967295,v=T+(S<<20&4294967295|S>>>12),S=p+(T^C&(v^T))+w[13]+2850285829&4294967295,p=v+(S<<5&4294967295|S>>>27),S=C+(v^T&(p^v))+w[2]+4243563512&4294967295,C=p+(S<<9&4294967295|S>>>23),S=T+(p^v&(C^p))+w[7]+1735328473&4294967295,T=C+(S<<14&4294967295|S>>>18),S=v+(C^p&(T^C))+w[12]+2368359562&4294967295,v=T+(S<<20&4294967295|S>>>12),S=p+(v^T^C)+w[5]+4294588738&4294967295,p=v+(S<<4&4294967295|S>>>28),S=C+(p^v^T)+w[8]+2272392833&4294967295,C=p+(S<<11&4294967295|S>>>21),S=T+(C^p^v)+w[11]+1839030562&4294967295,T=C+(S<<16&4294967295|S>>>16),S=v+(T^C^p)+w[14]+4259657740&4294967295,v=T+(S<<23&4294967295|S>>>9),S=p+(v^T^C)+w[1]+2763975236&4294967295,p=v+(S<<4&4294967295|S>>>28),S=C+(p^v^T)+w[4]+1272893353&4294967295,C=p+(S<<11&4294967295|S>>>21),S=T+(C^p^v)+w[7]+4139469664&4294967295,T=C+(S<<16&4294967295|S>>>16),S=v+(T^C^p)+w[10]+3200236656&4294967295,v=T+(S<<23&4294967295|S>>>9),S=p+(v^T^C)+w[13]+681279174&4294967295,p=v+(S<<4&4294967295|S>>>28),S=C+(p^v^T)+w[0]+3936430074&4294967295,C=p+(S<<11&4294967295|S>>>21),S=T+(C^p^v)+w[3]+3572445317&4294967295,T=C+(S<<16&4294967295|S>>>16),S=v+(T^C^p)+w[6]+76029189&4294967295,v=T+(S<<23&4294967295|S>>>9),S=p+(v^T^C)+w[9]+3654602809&4294967295,p=v+(S<<4&4294967295|S>>>28),S=C+(p^v^T)+w[12]+3873151461&4294967295,C=p+(S<<11&4294967295|S>>>21),S=T+(C^p^v)+w[15]+530742520&4294967295,T=C+(S<<16&4294967295|S>>>16),S=v+(T^C^p)+w[2]+3299628645&4294967295,v=T+(S<<23&4294967295|S>>>9),S=p+(T^(v|~C))+w[0]+4096336452&4294967295,p=v+(S<<6&4294967295|S>>>26),S=C+(v^(p|~T))+w[7]+1126891415&4294967295,C=p+(S<<10&4294967295|S>>>22),S=T+(p^(C|~v))+w[14]+2878612391&4294967295,T=C+(S<<15&4294967295|S>>>17),S=v+(C^(T|~p))+w[5]+4237533241&4294967295,v=T+(S<<21&4294967295|S>>>11),S=p+(T^(v|~C))+w[12]+1700485571&4294967295,p=v+(S<<6&4294967295|S>>>26),S=C+(v^(p|~T))+w[3]+2399980690&4294967295,C=p+(S<<10&4294967295|S>>>22),S=T+(p^(C|~v))+w[10]+4293915773&4294967295,T=C+(S<<15&4294967295|S>>>17),S=v+(C^(T|~p))+w[1]+2240044497&4294967295,v=T+(S<<21&4294967295|S>>>11),S=p+(T^(v|~C))+w[8]+1873313359&4294967295,p=v+(S<<6&4294967295|S>>>26),S=C+(v^(p|~T))+w[15]+4264355552&4294967295,C=p+(S<<10&4294967295|S>>>22),S=T+(p^(C|~v))+w[6]+2734768916&4294967295,T=C+(S<<15&4294967295|S>>>17),S=v+(C^(T|~p))+w[13]+1309151649&4294967295,v=T+(S<<21&4294967295|S>>>11),S=p+(T^(v|~C))+w[4]+4149444226&4294967295,p=v+(S<<6&4294967295|S>>>26),S=C+(v^(p|~T))+w[11]+3174756917&4294967295,C=p+(S<<10&4294967295|S>>>22),S=T+(p^(C|~v))+w[2]+718787259&4294967295,T=C+(S<<15&4294967295|S>>>17),S=v+(C^(T|~p))+w[9]+3951481745&4294967295,E.g[0]=E.g[0]+p&4294967295,E.g[1]=E.g[1]+(T+(S<<21&4294967295|S>>>11))&4294967295,E.g[2]=E.g[2]+T&4294967295,E.g[3]=E.g[3]+C&4294967295}r.prototype.v=function(E,p){p===void 0&&(p=E.length);const v=p-this.blockSize,w=this.C;let T=this.h,C=0;for(;C<p;){if(T==0)for(;C<=v;)s(this,E,C),C+=this.blockSize;if(typeof E=="string"){for(;C<p;)if(w[T++]=E.charCodeAt(C++),T==this.blockSize){s(this,w),T=0;break}}else for(;C<p;)if(w[T++]=E[C++],T==this.blockSize){s(this,w),T=0;break}}this.h=T,this.o+=p},r.prototype.A=function(){var E=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);E[0]=128;for(var p=1;p<E.length-8;++p)E[p]=0;p=this.o*8;for(var v=E.length-8;v<E.length;++v)E[v]=p&255,p/=256;for(this.v(E),E=Array(16),p=0,v=0;v<4;++v)for(let w=0;w<32;w+=8)E[p++]=this.g[v]>>>w&255;return E};function i(E,p){var v=l;return Object.prototype.hasOwnProperty.call(v,E)?v[E]:v[E]=p(E)}function o(E,p){this.h=p;const v=[];let w=!0;for(let T=E.length-1;T>=0;T--){const C=E[T]|0;w&&C==p||(v[T]=C,w=!1)}this.g=v}var l={};function u(E){return-128<=E&&E<128?i(E,function(p){return new o([p|0],p<0?-1:0)}):new o([E|0],E<0?-1:0)}function h(E){if(isNaN(E)||!isFinite(E))return m;if(E<0)return O(h(-E));const p=[];let v=1;for(let w=0;E>=v;w++)p[w]=E/v|0,v*=4294967296;return new o(p,0)}function f(E,p){if(E.length==0)throw Error("number format error: empty string");if(p=p||10,p<2||36<p)throw Error("radix out of range: "+p);if(E.charAt(0)=="-")return O(f(E.substring(1),p));if(E.indexOf("-")>=0)throw Error('number format error: interior "-" character');const v=h(Math.pow(p,8));let w=m;for(let C=0;C<E.length;C+=8){var T=Math.min(8,E.length-C);const S=parseInt(E.substring(C,C+T),p);T<8?(T=h(Math.pow(p,T)),w=w.j(T).add(h(S))):(w=w.j(v),w=w.add(h(S)))}return w}var m=u(0),_=u(1),A=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-O(this).m();let E=0,p=1;for(let v=0;v<this.g.length;v++){const w=this.i(v);E+=(w>=0?w:4294967296+w)*p,p*=4294967296}return E},t.toString=function(E){if(E=E||10,E<2||36<E)throw Error("radix out of range: "+E);if(P(this))return"0";if(N(this))return"-"+O(this).toString(E);const p=h(Math.pow(E,6));var v=this;let w="";for(;;){const T=b(v,p).g;v=x(v,T.j(p));let C=((v.g.length>0?v.g[0]:v.h)>>>0).toString(E);if(v=T,P(v))return C+w;for(;C.length<6;)C="0"+C;w=C+w}},t.i=function(E){return E<0?0:E<this.g.length?this.g[E]:this.h};function P(E){if(E.h!=0)return!1;for(let p=0;p<E.g.length;p++)if(E.g[p]!=0)return!1;return!0}function N(E){return E.h==-1}t.l=function(E){return E=x(this,E),N(E)?-1:P(E)?0:1};function O(E){const p=E.g.length,v=[];for(let w=0;w<p;w++)v[w]=~E.g[w];return new o(v,~E.h).add(_)}t.abs=function(){return N(this)?O(this):this},t.add=function(E){const p=Math.max(this.g.length,E.g.length),v=[];let w=0;for(let T=0;T<=p;T++){let C=w+(this.i(T)&65535)+(E.i(T)&65535),S=(C>>>16)+(this.i(T)>>>16)+(E.i(T)>>>16);w=S>>>16,C&=65535,S&=65535,v[T]=S<<16|C}return new o(v,v[v.length-1]&-2147483648?-1:0)};function x(E,p){return E.add(O(p))}t.j=function(E){if(P(this)||P(E))return m;if(N(this))return N(E)?O(this).j(O(E)):O(O(this).j(E));if(N(E))return O(this.j(O(E)));if(this.l(A)<0&&E.l(A)<0)return h(this.m()*E.m());const p=this.g.length+E.g.length,v=[];for(var w=0;w<2*p;w++)v[w]=0;for(w=0;w<this.g.length;w++)for(let T=0;T<E.g.length;T++){const C=this.i(w)>>>16,S=this.i(w)&65535,ee=E.i(T)>>>16,fe=E.i(T)&65535;v[2*w+2*T]+=S*fe,I(v,2*w+2*T),v[2*w+2*T+1]+=C*fe,I(v,2*w+2*T+1),v[2*w+2*T+1]+=S*ee,I(v,2*w+2*T+1),v[2*w+2*T+2]+=C*ee,I(v,2*w+2*T+2)}for(E=0;E<p;E++)v[E]=v[2*E+1]<<16|v[2*E];for(E=p;E<2*p;E++)v[E]=0;return new o(v,0)};function I(E,p){for(;(E[p]&65535)!=E[p];)E[p+1]+=E[p]>>>16,E[p]&=65535,p++}function k(E,p){this.g=E,this.h=p}function b(E,p){if(P(p))throw Error("division by zero");if(P(E))return new k(m,m);if(N(E))return p=b(O(E),p),new k(O(p.g),O(p.h));if(N(p))return p=b(E,O(p)),new k(O(p.g),p.h);if(E.g.length>30){if(N(E)||N(p))throw Error("slowDivide_ only works with positive integers.");for(var v=_,w=p;w.l(E)<=0;)v=M(v),w=M(w);var T=U(v,1),C=U(w,1);for(w=U(w,2),v=U(v,2);!P(w);){var S=C.add(w);S.l(E)<=0&&(T=T.add(v),C=S),w=U(w,1),v=U(v,1)}return p=x(E,T.j(p)),new k(T,p)}for(T=m;E.l(p)>=0;){for(v=Math.max(1,Math.floor(E.m()/p.m())),w=Math.ceil(Math.log(v)/Math.LN2),w=w<=48?1:Math.pow(2,w-48),C=h(v),S=C.j(p);N(S)||S.l(E)>0;)v-=w,C=h(v),S=C.j(p);P(C)&&(C=_),T=T.add(C),E=x(E,S)}return new k(T,E)}t.B=function(E){return b(this,E).h},t.and=function(E){const p=Math.max(this.g.length,E.g.length),v=[];for(let w=0;w<p;w++)v[w]=this.i(w)&E.i(w);return new o(v,this.h&E.h)},t.or=function(E){const p=Math.max(this.g.length,E.g.length),v=[];for(let w=0;w<p;w++)v[w]=this.i(w)|E.i(w);return new o(v,this.h|E.h)},t.xor=function(E){const p=Math.max(this.g.length,E.g.length),v=[];for(let w=0;w<p;w++)v[w]=this.i(w)^E.i(w);return new o(v,this.h^E.h)};function M(E){const p=E.g.length+1,v=[];for(let w=0;w<p;w++)v[w]=E.i(w)<<1|E.i(w-1)>>>31;return new o(v,E.h)}function U(E,p){const v=p>>5;p%=32;const w=E.g.length-v,T=[];for(let C=0;C<w;C++)T[C]=p>0?E.i(C+v)>>>p|E.i(C+v+1)<<32-p:E.i(C+v);return new o(T,E.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,gw=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,hs=o}).apply(typeof ey<"u"?ey:typeof self<"u"?self:typeof window<"u"?window:{});var ml=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jP=Z.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:s="",children:i,iconNode:o,...l},u)=>Z.createElement("svg",{ref:u,...MP,width:e,height:e,stroke:t,strokeWidth:r?Number(n)*24/Number(e):n,className:XE("lucide",s),...!i&&!LP(l)&&{"aria-hidden":"true"},...l},[...o.map(([h,f])=>Z.createElement(h,f)),...Array.isArray(i)?i:[i]]));/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=(t,e)=>{const n=Z.forwardRef(({className:r,...s},i)=>Z.createElement(jP,{ref:i,iconNode:e,className:XE(`lucide-${OP(Xy(t))}`,`lucide-${t}`,r),...s}));return n.displayName=Xy(t),n};/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
